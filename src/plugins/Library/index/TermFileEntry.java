...
public class TermFileEntry extends TermEntry {
	...
	**          surrounding it).
	*/
	/*	public TermFileEntry(String s, float r, FreenetURI u, Map<Integer, String> p) {
...
*/
	...
	**          surrounding it).
	*/
/*	public TermFileEntry(String s, float r, FreenetURI u, String t, Map<Integer, String> p) {
		super(s, r);
		if (u == null) {
...
*/
	...
	** For serialisation.
	*/
	public TermFileEntry(String s, float r, FreenetURI u, String m, String d, Set<Integer> pos, Map<Integer, String> frags) {
		super(s, r);
		if (u == null) {
			throw new IllegalArgumentException("can't have a null page");
		}
	...
	public TermFileEntry(TermFileEntry t, float newRel) {
		super(t, newRel);
		this.file = t.file;
	...
	@Override public int compareTo(TermEntry o) {
		...
		return file.toString().compareTo(((TermFileEntry)o).file.toString()) +
				mimeType.toString().compareTo(((TermFileEntry)o).mimeType.toString());
	}

	@Override public boolean equals(Object o) {
		return o == this || super.equals(o) && 
				file.equals(((TermFileEntry)o).file) && 
				mimeType.equals(((TermFileEntry)o).mimeType);
	}

	@Override public boolean equalsTarget(TermEntry entry) { 
		return entry == this || (entry instanceof TermFileEntry) && 
				file.equals(((TermFileEntry)entry).file) &&
				mimeType.equals(((TermFileEntry)entry).mimeType);
	}

	@Override public int hashCode() {
		return super.hashCode() ^ file.hashCode() ^ mimeType.hashCode();
	}
